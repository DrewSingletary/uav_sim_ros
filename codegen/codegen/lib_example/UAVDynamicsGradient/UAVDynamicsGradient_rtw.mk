###########################################################################
## Makefile generated for MATLAB file/project 'UAVDynamicsGradient'. 
## 
## Makefile     : UAVDynamicsGradient_rtw.mk
## Generated on : Tue Feb 25 17:18:41 2020
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: ./UAVDynamicsGradient.a
...
PRODUCT_NAME              = UAVDynamicsGradient
MAKEFILE                  = UAVDynamicsGradient_rtw.mk
COMPUTER                  = MACI64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Volumes/Shared/ROS/uav_sim_ros/codegen/codegen/lib/UAVDynamicsGradient
ARCH                      = maci64
TGT_FCN_LIB               = ISO_C++
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=UAVDynamicsGradient -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/UAVDynamicsGradient_initialize.cpp $(START_DIR)/UAVDynamicsGradient_terminate.cpp $(START_DIR)/UAVDynamicsGradient.cpp $(START_DIR)/rt_nonfinite.cpp $(START_DIR)/rtGetNaN.cpp $(START_DIR)/rtGetInf.cpp
...
OBJS = UAVDynamicsGradient_initialize.o UAVDynamicsGradient_terminate.o UAVDynamicsGradient.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
