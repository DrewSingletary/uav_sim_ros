###########################################################################
## Makefile generated for MATLAB file/project 'UAVDynamicsWithGrad'. 
## 
## Makefile     : UAVDynamicsWithGrad_rtw.mk
## Generated on : Tue Feb 25 17:18:38 2020
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: ./UAVDynamicsWithGrad.a
...
PRODUCT_NAME              = UAVDynamicsWithGrad
MAKEFILE                  = UAVDynamicsWithGrad_rtw.mk
COMPUTER                  = MACI64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Volumes/Shared/ROS/uav_sim_ros/codegen/codegen/lib/UAVDynamicsWithGrad
ARCH                      = maci64
TGT_FCN_LIB               = ISO_C++
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=UAVDynamicsWithGrad -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/UAVDynamicsWithGrad_initialize.cpp $(START_DIR)/UAVDynamicsWithGrad_terminate.cpp $(START_DIR)/UAVDynamicsWithGrad.cpp $(START_DIR)/matf.cpp $(START_DIR)/matDFcl.cpp $(START_DIR)/rt_nonfinite.cpp $(START_DIR)/rtGetNaN.cpp $(START_DIR)/rtGetInf.cpp
...
OBJS = UAVDynamicsWithGrad_initialize.o UAVDynamicsWithGrad_terminate.o UAVDynamicsWithGrad.o matf.o matDFcl.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
