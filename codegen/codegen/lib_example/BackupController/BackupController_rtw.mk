###########################################################################
## Makefile generated for MATLAB file/project 'BackupController'. 
## 
## Makefile     : BackupController_rtw.mk
## Generated on : Tue Feb 25 22:48:44 2020
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: ./BackupController.a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Volumes/Shared/ROS/uav_sim_ros/codegen/codegen/lib/BackupController
ARCH                      = maci64
TGT_FCN_LIB               = ISO_C++
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Volumes/Shared/ROS/uav_sim_ros/codegen -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=BackupController -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/BackupController_rtwutil.cpp $(START_DIR)/BackupController_initialize.cpp $(START_DIR)/BackupController_terminate.cpp $(START_DIR)/BackupController.cpp $(START_DIR)/backupU.cpp $(START_DIR)/rt_nonfinite.cpp $(START_DIR)/rtGetNaN.cpp $(START_DIR)/rtGetInf.cpp
...
OBJS = BackupController_rtwutil.o BackupController_initialize.o BackupController_terminate.o BackupController.o backupU.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
...
%.o : /Volumes/Shared/ROS/uav_sim_ros/codegen/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Volumes/Shared/ROS/uav_sim_ros/codegen/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
