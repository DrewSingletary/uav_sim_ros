...
#include "main.h"
#include "UAVDynamics_terminate.h"
#include "UAVDynamics_initialize.h"

// Function Declarations
static void argInit_17x1_real_T(double result[17]);
static double argInit_real_T();
static void main_UAVDynamics();
...
static void main_UAVDynamics()
{
  ...
  // Initialize function 'UAVDynamics' input arguments.
  // Initialize function input argument 'X'.
  // Call the entry-point 'UAVDynamics'.
