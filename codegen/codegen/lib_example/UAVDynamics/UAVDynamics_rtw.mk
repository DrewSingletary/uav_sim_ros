###########################################################################
## Makefile generated for MATLAB file/project 'UAVDynamics'. 
## 
## Makefile     : UAVDynamics_rtw.mk
## Generated on : Mon Feb 24 16:33:18 2020
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: ./UAVDynamics.a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Volumes/Shared/ROS/uav_sim_ros/codegen/codegen/lib/UAVDynamics
ARCH                      = maci64
TGT_FCN_LIB               = ISO_C++
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=UAVDynamics -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/UAVDynamics_initialize.cpp $(START_DIR)/UAVDynamics_terminate.cpp $(START_DIR)/UAVDynamics.cpp
...
OBJS = UAVDynamics_initialize.o UAVDynamics_terminate.o UAVDynamics.o
